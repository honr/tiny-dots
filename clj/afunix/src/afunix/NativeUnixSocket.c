 ...
 * junixsocket
 *
 * Copyright (c) 2009, 2010 NewsClub, Christian Kohlschuetter
 *
...
#include "afunix_NativeUnixSocket.h"
 ...
 */
	void afunix_NativeUnixSocket_throwException(JNIEnv* env, char* message, jstring file) {
		jclass exc = (*env)->FindClass(env, "afunix/AFUNIXSocketException");
	...
	int afunix_NativeUnixSocket_getFD(JNIEnv * env, jobject fd) {
		jclass fileDescriptorClass = (*env)->GetObjectClass(env, fd);
		jfieldID fdField = (*env)->GetFieldID(env, fileDescriptorClass, "fd", "I");
		if(fdField == NULL) {
			afunix_NativeUnixSocket_throwException(env, "Cannot find field \"fd\" in java.io.FileDescriptor. Unsupported JVM?", NULL);
			return 0;
		}
		return (*env)->GetIntField(env, fd, fdField);
	}
	
	void afunix_NativeUnixSocket_initFD(JNIEnv * env, jobject fd, int handle) {
		jclass fileDescriptorClass = (*env)->GetObjectClass(env, fd);
		jfieldID fdField = (*env)->GetFieldID(env, fileDescriptorClass, "fd", "I");
		if(fdField == NULL) {
			afunix_NativeUnixSocket_throwException(env, "Cannot find field \"fd\" in java.io.FileDescriptor. Unsupported JVM?", NULL);
	...
	/*
	 * Class:     afunix_NativeUnixSocket
	 * Method:    accept
	 * Signature: (Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/FileDescriptor;)V
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_accept
	(JNIEnv * env, jclass clazz, jstring file, jobject fdServer, jobject fd) {
		...
		if(strlen(socketFile) >= 104) {
			...
			afunix_NativeUnixSocket_throwException(env, "Pathname too long for socket", file);
			return;
		}
		
		int serverHandle = afunix_NativeUnixSocket_getFD(env, fdServer);
		...
		if(socketHandle == -1) {
			afunix_NativeUnixSocket_throwException(env, strerror(errno), file);
			return;
		}
		
		afunix_NativeUnixSocket_initFD(env, fd, socketHandle);
		return;
	}
	 ...
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_bind
	(JNIEnv * env, jclass clazz, jstring file, jobject fd, jint backlog) {
		...
		if(ret == -1) {
			afunix_NativeUnixSocket_throwException(env, strerror(errno), NULL);
		}        
		...
		if(bindRes == -1) {
            ...
            if(errno == EADDRINUSE) {
                ...
                if(ret == -1 && errno == ECONNREFUSED) {
                    ...
                    if(bindRes == -1) {
                        close(serverHandle);
                        afunix_NativeUnixSocket_throwException(env, strerror(myErr), file);
                        return;
                    }
                } else {
                    close(serverHandle);
		...
		afunix_NativeUnixSocket_initFD(env, fd, serverHandle);
	}		
	 ...
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_listen
	(JNIEnv * env, jclass clazz, jobject fd, jint backlog) {
		int serverHandle = afunix_NativeUnixSocket_getFD(env, fd);
	 ...
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_connect
	 ...
	 */
	JNIEXPORT jint JNICALL Java_afunix_NativeUnixSocket_read
	(JNIEnv * env, jclass clazz, jobject fd, jbyteArray jbuf, jint offset, jint length) {
		...
		int handle = afunix_NativeUnixSocket_getFD(env, fd);
...
//			}
	 ...
	 * Signature: (Ljava/io/FileDescriptor;[BII)I
	 */
	JNIEXPORT jint JNICALL Java_afunix_NativeUnixSocket_write
	(JNIEnv * env, jclass clazz, jobject fd, jbyteArray jbuf, jint offset, jint length) {
		jbyte *buf = (*env)->GetByteArrayElements(env, jbuf, NULL);
		if(buf == NULL) {
			return -1; // OOME
	 ...
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_close
	 ...
	 * Signature: (Ljava/io/FileDescriptor;I)V
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_shutdown
	 ...
	 */
	JNIEXPORT jint JNICALL Java_afunix_NativeUnixSocket_getSocketOptionInt
	(JNIEnv * env, jclass clazz, jobject fd, jint optID) {
		int handle = afunix_NativeUnixSocket_getFD(env, fd);
        
        optID = convertSocketOptionToNative(optID);
        if(optID == -1) {
            afunix_NativeUnixSocket_throwException(env, "Unsupported socket option", NULL);
            return -1;
        }
	 ...
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_setSocketOptionInt
	 ...
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_unlink
	 ...
	 */
	JNIEXPORT jint JNICALL Java_afunix_NativeUnixSocket_available
	(JNIEnv * env, jclass clazz, jobject fd) {
		int handle = afunix_NativeUnixSocket_getFD(env, fd);
	 ...
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_initServerImpl
	(JNIEnv * env, jclass clazz, jobject serverSocket, jobject impl) {
		...
		if(fieldID == NULL) {
			afunix_NativeUnixSocket_throwException(env, "Cannot find field \"impl\" in java.net.SocketImpl. Unsupported JVM?", NULL);
			return;
		}
	 ...
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_setCreated
	(JNIEnv * env, jclass clazz, jobject socket) {
		...
		if(methodID == NULL) {
			afunix_NativeUnixSocket_throwException(env, "Cannot find method \"setCreated\" in java.net.Socket. Unsupported JVM?", NULL);
			return;
		}
	 ...
	 * Signature: (Lcom/newsclub/net/unix/AFUNIXSocket;)V
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_setConnected
	(JNIEnv * env, jclass clazz, jobject socket) {
		jclass socketClass = (*env)->GetObjectClass(env, socket);
		jmethodID methodID = (*env)->GetMethodID(env, socketClass, "setConnected", "()V");
		if(methodID == NULL) {
			afunix_NativeUnixSocket_throwException(env, "Cannot find method \"setConnected\" in java.net.Socket. Unsupported JVM?", NULL);
			return;
		}
		(*env)->CallVoidMethod(env, socket, methodID);
	}
	 ...
	 * Signature: (Lcom/newsclub/net/unix/AFUNIXSocket;)V
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_setBound
	(JNIEnv * env, jclass clazz, jobject socket) {
		jclass socketClass = (*env)->GetObjectClass(env, socket);
		jmethodID methodID = (*env)->GetMethodID(env, socketClass, "setBound", "()V");
		if(methodID == NULL) {
			afunix_NativeUnixSocket_throwException(env, "Cannot find method \"setBound\" in java.net.Socket. Unsupported JVM?", NULL);
			return;
		}
		(*env)->CallVoidMethod(env, socket, methodID);
	}
	 ...
	 * Signature: (Lafunix/AFUNIXServerSocket;)V
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_setCreatedServer
	(JNIEnv * env, jclass clazz, jobject socket) {
		jclass socketClass = (*env)->GetObjectClass(env, socket);
		jmethodID methodID = (*env)->GetMethodID(env, socketClass, "setCreated", "()V");
		if(methodID == NULL) {
			afunix_NativeUnixSocket_throwException(env, "Cannot find method \"setCreated\" in java.net.ServerSocket. Unsupported JVM?", NULL);
			return;
		}
		(*env)->CallVoidMethod(env, socket, methodID);
	}
	 ...
	 * Signature: (Lafunix/AFUNIXServerSocket;)V
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_setBoundServer
	(JNIEnv * env, jclass clazz, jobject socket) {
		jclass socketClass = (*env)->GetObjectClass(env, socket);
		jmethodID methodID = (*env)->GetMethodID(env, socketClass, "setBound", "()V");
		if(methodID == NULL) {
			afunix_NativeUnixSocket_throwException(env, "Cannot find method \"setBound\" in java.net.ServerSocket. Unsupported JVM?", NULL);
			return;
		}
		(*env)->CallVoidMethod(env, socket, methodID);
	}
	 ...
	 * Class:     afunix_NativeUnixSocket
	 * Method:    setPort
	 * Signature: (Lafunix/AFUNIXSocketAddress;I)V
	 */
	JNIEXPORT void JNICALL Java_afunix_NativeUnixSocket_setPort
	(JNIEnv * env, jclass clazz, jobject addr, jint port) {
		...
		if(portField == NULL) {
			afunix_NativeUnixSocket_throwException(env, "Cannot find field \"port\" in java.net.InetSocketAddress. Unsupported JVM?", NULL);
			return;
		}
